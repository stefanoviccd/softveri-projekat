 ...
 */
public class GetUserRentsSO extends AbstractSO{
    RepositoryRent repositoryRent;

    public GetUserRentsSO() {
    ...
    protected Object executeOperation(Object param) throws Exception {
        List<Rent> rents=repositoryRent.getUserRents((User)param);
        System.out.println(rents);
        return repositoryRent.getUserRents((User)param);
        }
